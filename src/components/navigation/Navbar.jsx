  ...
  return (
    <div className='flex z-4  fixed top-0 w-full items-start justify-between'>
       <div className='lg:p-3 p-2'>
        <div className='nav-logo lg:w-36 w-20'>
     ...
     onMouseEnter={()=>{NavYellowRef.current.style.height="100%"}}
     onMouseLeave={()=>{NavYellowRef.current.style.height="0%"}}
      className=' lg:h-12  h-10 lg:w-[15vw] w-40 bg-black relative'>
       <div ref={NavYellowRef} className='bg-[#D3FD50] transition-all absolute h-0 top-0 w-full '>
         <div  className=' relative lg:px-8 px-6 py-4 w-full flex flex-col justify-center items-end gap-1.5 '>
          <div className='lg:w-18 w-12 h-0.5 bg-white'></div>
          <div className='lg:w-13 w-9 h-0.5 bg-white'></div>
